...
from app.agents.social_media.state import SocialMediaState
from app.agents.social_media.nodes import fetch_metrics_node, analyze_alerts_node, should_analyze
...
async def run_agent(payload: dict):
    state = {"messages": [], "session_id": payload.get("session_id",""), "query": payload.get("query",""),
             "context": payload.get("context",{}), "channel_reports": [], "alerts": [], "result": None, "status": "running"}
